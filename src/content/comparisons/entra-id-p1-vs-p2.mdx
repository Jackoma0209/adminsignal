...
reviewNote: "Corrected P1 risk-policy claims and qualified P2 versus ID Governance capabilities and beneficiary licensing. Recommendations are documentation-based and require agreement-specific licence checks."
...
- **Conditional Access** (standard policies including named locations and compliant-device requirements; risk-based policies require P2)
...
This is a compliance feature as much as a security feature. Map the evidence to your organisation’s assessed controls; a particular Microsoft licence is not itself proof of compliance.
...
| Access reviews | Not a P1 feature | Selected capabilities; advanced scenarios require ID Governance |
| Entitlement management | Not a P1 feature | Selected capabilities; check ID Governance requirements |
| Conditional Access: sign-in/user risk policies | No | Yes |
...
- An assessed control requirement for privileged-access governance or access reviews; do not assume a framework mandates a particular Microsoft product
...
If you are on Microsoft 365 E3, adding P2 to your entire tenant can be significant. Consider a **targeted P2 licensing approach**: licence P2 only for users in privileged roles (Global Admins, Privileged Role Admins, Security Admins) and leave standard users on E3 (which includes P1). This can be appropriate for a narrowly scoped PIM deployment, but does not license tenant-wide risk policies or reviews. Cover every user benefiting from each selected feature, including eligible/active role holders and required approvers or reviewers. Advanced governance features and guest scenarios have separate requirements. [Microsoft Entra licensing](https://learn.microsoft.com/en-us/entra/fundamentals/licensing) and [ID Governance licensing](https://learn.microsoft.com/en-us/entra/id-governance/licensing-fundamentals).
...
2. Map the entitlement for every pilot participant and feature, including users being reviewed and approvers. Do not assume admin-only P2 licensing covers all beneficiaries.
3. Convert permanent privileged roles to eligible assignments in PIM for one non-emergency admin cohort.
4. Scope a medium/high sign-in risk Conditional Access policy only to properly licensed pilot users, initially in report-only mode.
...
- [Microsoft Entra licensing and feature availability](https://learn.microsoft.com/en-us/entra/fundamentals/licensing)
...
**10 September 2026:** Corrected P1 risk-policy claims and qualified P2 versus ID Governance capabilities and beneficiary licensing. Recommendations are documentation-based and require agreement-specific licence checks.
