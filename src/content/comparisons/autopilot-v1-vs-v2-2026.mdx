...
For wider Intune architecture, keep the [Intune hub](/intune) open beside this guide. For identity design, use the [Microsoft Entra ID hub](/microsoft-entra-id). If you are building a new Windows 11 rollout, use [Windows 11 25H2 vs 26H1](/comparisons/windows-11-25h2-vs-26h1-2026) for servicing scope before you pick an Autopilot path. If imports or deployment tracking are already failing, use [Autopilot Device Not Importing Hardware Hash](/troubleshooting/autopilot-device-not-importing-hardware-hash) and [Autopilot Enrollment Status Page Stuck](/troubleshooting/autopilot-enrollment-status-page-stuck) before changing the design.
...
For deeper v2 flow diagnosis, use [Autopilot Enrollment Status Page Stuck](/troubleshooting/autopilot-enrollment-status-page-stuck). For import problems, use [Autopilot Device Not Importing Hardware Hash](/troubleshooting/autopilot-device-not-importing-hardware-hash).
...
- [Windows 11 25H2 vs 26H1](/comparisons/windows-11-25h2-vs-26h1-2026)
