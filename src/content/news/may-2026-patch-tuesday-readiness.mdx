...
If you need a consolidated view of installed and missing updates across your estate, the [Windows Update for Business deferral troubleshooting](/troubleshooting/wufb-deferral-not-respected) provides a per-device summary suitable for use as change record evidence.
...
4. Run the [Windows Update for Business deferral troubleshooting](/troubleshooting/wufb-deferral-not-respected) to cross-check Intune, ConfigMgr, Defender, and WSUS reporting for drift across the estate.
...
- [Windows Update for Business deferral troubleshooting](/troubleshooting/wufb-deferral-not-respected) for a consolidated per-device view of installed and missing updates.
