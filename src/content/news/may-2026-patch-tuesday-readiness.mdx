...
reviewNote: "Removed the contradictory all-clear for releases with a documented BitLocker issue; labelled known-issue information as historical."
...
**Historical known-issue snapshot:** The issue descriptions above belong to the May deployment context. They are not a current all-clear for 24H2/25H2 or any other release. Before a new rollout, check the applicable current cumulative update and [Windows release health](https://learn.microsoft.com/en-us/windows/release-health/) for resolutions and new issues. This replaces the contradictory “no current known issues” paragraph that followed the BitLocker warning.
...
**10 September 2026 — Reviewed against documentation:** Removed the contradictory all-clear for releases with a documented BitLocker issue; labelled known-issue information as historical. Examples are illustrative; no lab or tenant execution is claimed.
