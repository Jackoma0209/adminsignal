...
- [Secure Boot CA 2023 enterprise readiness](/tutorials/secure-boot-ca-2023-rollout-enterprise-readiness)
...
- [Microsoft documentation: Encrypt Windows devices with BitLocker in Intune](https://learn.microsoft.com/en-us/intune/device-configuration/endpoint-security/encrypt-bitlocker-windows)
- [Microsoft documentation: Manage device identities in Microsoft Entra ID](https://learn.microsoft.com/en-us/entra/identity/devices/manage-device-identities)
