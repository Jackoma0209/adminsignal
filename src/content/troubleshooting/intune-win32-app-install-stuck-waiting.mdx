...
{/* Jack must drop in a redacted capture. Do not generate a fake Intune app install status image. */}
<ScreenshotSlot
  alt="Microsoft Intune admin centre Apps > Windows > app > Device install status, showing a device in Waiting for install with device name and UPN redacted"
  caption="Win32 app device install status. Paste a redacted capture of this blade."
/>
