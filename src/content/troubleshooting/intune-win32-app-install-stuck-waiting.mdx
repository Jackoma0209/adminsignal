...
**10 September 2026 — Reviewed against documentation:** Clarified example status and used a verified Entra object ID to avoid ambiguous display-name matches. Code and output remain illustrative, not execution evidence.
