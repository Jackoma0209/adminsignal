...
{/* Jack must drop in a redacted capture. Do not generate a fake Intune device overview image. */}
<ScreenshotSlot
  alt="Microsoft Intune admin centre Devices > Windows devices > device Overview, showing Last check-in and MDM with device name, UPN, and tenant redacted"
  caption="Intune device Overview last check-in. Paste a redacted capture of this blade."
/>
