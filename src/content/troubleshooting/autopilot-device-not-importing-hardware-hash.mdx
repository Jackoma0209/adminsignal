...
{/* Jack must drop in a redacted capture. Do not generate a fake Intune Autopilot devices image. */}
<ScreenshotSlot
  alt="Microsoft Intune admin centre Devices > Windows > Windows enrollment > Devices, showing an Autopilot import status row with serial number and tenant name redacted"
  caption="Windows Autopilot devices import status. Paste a redacted capture of this blade."
/>
