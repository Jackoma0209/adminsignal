...
The workload-slider decision path on this page was not lab-tested. The recorded evidence in Step 2 is a redacted home-lab handler and scan excerpt only. UseWUServer and WUServer were not present, so that excerpt does not prove scan-source ownership.
