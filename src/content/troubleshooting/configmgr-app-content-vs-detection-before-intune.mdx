...
reviewNote: "Reviewed against Microsoft Configuration Manager application deployment troubleshooting documentation. No lab tests were performed and no AppDiscovery or AppEnforce logs from a live tenant are included."
