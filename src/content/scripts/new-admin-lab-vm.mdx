...
Use this guide to create repeatable lab or pilot virtual machines for authorised testing of endpoint policy, Group Policy, Intune enrolment, hardening, and troubleshooting workflows. It is intended for isolated administrative test environments, not for creating unmanaged production endpoints.
...
| Version | Date | Notes |
|---|---|---|
| Guide v0.2 | Apr 27, 2026 | Added WinRM, Secure Boot, teardown, and password-handling guidance |
| Guide v0.1 | Jan 2025 | Initial Hyper-V lab VM implementation guide |
