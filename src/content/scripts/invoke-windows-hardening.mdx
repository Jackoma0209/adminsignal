...
Use this guide to plan an authorised defensive hardening workflow for managed Windows endpoints. The goal is to audit configuration drift, apply approved baseline settings in a pilot-first sequence, and produce evidence for compliance review. It is not a tool for bypassing policy, hiding activity, or changing systems without owner approval.
...
| Version | Date | Notes |
|---|---|---|
| Guide v0.2 | Apr 27, 2026 | Added pilot-first safety sequence, rollback guidance, and Intune remediation notes |
| Guide v0.1 | Mar 2025 | Initial hardening implementation guide |
