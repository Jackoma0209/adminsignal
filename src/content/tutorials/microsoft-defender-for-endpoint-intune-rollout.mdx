...
{/* Jack must drop in a redacted capture. Do not generate a fake Intune or Defender portal image. */}
<ScreenshotSlot
  alt="Microsoft Intune admin centre Endpoint security > Microsoft Defender for Endpoint, showing the tenant connector status with tenant ID redacted"
  caption="Intune Defender for Endpoint connector blade. Paste a redacted capture of this blade."
/>
