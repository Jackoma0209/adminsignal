...
<ScreenshotSlot
  src="/images/evidence/intune-defender-connector.png"
  alt="Microsoft Intune admin centre, Endpoint security, Microsoft Defender for Endpoint connector, with tenant identity redacted"
  caption="Intune Microsoft Defender for Endpoint connector blade. Tenant identity redacted. Connection status shown as unavailable until the security centre link is completed."
/>
