...
<ScreenshotSlot
  src="/images/evidence/eac-smtp-auth-clients.png"
  alt="Exchange admin centre, Reports, Mail flow, SMTP AUTH clients report, with profile identity redacted"
  caption="EAC SMTP AUTH clients report. Profile identity redacted. This window shows no SMTP AUTH traffic in the last seven days."
/>
