...
{/* Jack must drop in a redacted capture. Do not generate a fake Exchange admin centre image. */}
<ScreenshotSlot
  alt="Exchange admin centre Reports > Mail flow > SMTP AUTH clients, showing authenticated sender counts with tenant name and mailbox addresses redacted"
  caption="EAC SMTP AUTH clients report. Paste a redacted capture of this report."
/>
