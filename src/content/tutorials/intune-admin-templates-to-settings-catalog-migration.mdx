...
{/* Jack must drop in a redacted capture. Do not generate a fake Intune portal image. */}
<ScreenshotSlot
  alt="Microsoft Intune admin centre Devices > Configuration > Create > Settings catalog, showing the settings picker with tenant name redacted"
  caption="Intune Settings catalog profile creation blade. Paste a redacted capture of this blade."
/>
