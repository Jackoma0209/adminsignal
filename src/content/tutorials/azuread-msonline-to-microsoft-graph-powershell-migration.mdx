...
{/* Jack must drop in a redacted capture. Do not generate a fake Entra portal image. */}
<ScreenshotSlot
  alt="Microsoft Entra admin centre App registrations > Certificates and secrets, showing a certificate thumbprint with tenant name and object IDs redacted"
  caption="Entra app registration Certificates and secrets blade. Paste a redacted capture of this blade."
/>
