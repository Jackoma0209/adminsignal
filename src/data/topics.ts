...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    name: 'Group Policy',
    slug: 'group-policy',
    description: 'Prove why a setting is not applying, then decide whether Active Directory or Intune owns that setting.',
    icon: 'Settings',
  ...
  },
  {
    ...
    name: 'Windows Server',
    slug: 'windows-server',
    description: 'Group Policy processing against Active Directory, Secure Boot CA 2023 readiness, and related servicing notes.',
    icon: 'Server',
    iconBg: 'bg-muted/10',
