...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    name: 'Windows Server',
    slug: 'windows-server',
    description: 'Group Policy processing, Active Directory scope issues, and Secure Boot readiness.',
    icon: 'Server',
    iconBg: 'bg-muted/10',
  ...
  },
  {
    ...
    name: 'PowerShell',
    slug: 'powershell',
    description: 'Graph PowerShell migration, software inventory patterns, and admin automation examples.',
    icon: 'Terminal',
  ...
  },
  {
    ...
    name: 'Group Policy',
    slug: 'group-policy',
    description: 'RSoP, gpresult, scope filtering, and GPO coexistence with Intune.',
    icon: 'Settings',
